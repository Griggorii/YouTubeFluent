...
V2 hsla more rounded corners solved the problem of the main page of YouTube and filling with white, in case you want to enable a dark theme, then use a non-V2 version
